    ...
    <div className="container py-5">
      <div className="row justify-content-center">
        <div className="col-md-8 text-center mb-5">
          <h1 className="display-4 fw-bold text-primary donate-title mb-3">Support MWM Trust</h1>
      ...
      <div className="row justify-content-center">
        <div className="col-md-6">
          <div className="card shadow-lg border-0 rounded-4">
            <div className="card-header bg-primary donate-card-header text-white text-center py-4 rounded-top-4">
